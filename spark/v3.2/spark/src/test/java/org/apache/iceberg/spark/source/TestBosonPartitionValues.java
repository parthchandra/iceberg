...
public class TestBosonPartitionValues {
  ...
  public static void startSpark() {
    TestBosonPartitionValues.spark = SparkSession.builder()
        .master("local[2]")
  ...
  public static void stopSpark() {
    SparkSession currentSpark = TestBosonPartitionValues.spark;
    TestBosonPartitionValues.spark = null;
    currentSpark.stop();
  }
  ...
  public TestBosonPartitionValues(String format) {
    this.format = format;
  }
