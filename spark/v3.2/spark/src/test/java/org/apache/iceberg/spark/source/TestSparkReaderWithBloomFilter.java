...
public class TestSparkReaderWithBloomFilter {
  ...
  public static final Schema SCHEMA = new Schema(
      ...
      Types.NestedField.required(5, "id_binary", Types.StringType.get()),
  ...
  public void writeTestDataFile() throws IOException {
    ...
    for (int i = 0; i < INT_VALUE_COUNT; i += 1) {
      records.add(record.copy(
          ...
          "id_binary", BINARY_PREFIX + (INT_MIN_VALUE + i),
  ...
  public void testReadWithFilter() {
    Dataset<org.apache.spark.sql.Row> df = spark.read()
        ...
        .filter("id = 30 AND id_long = 1030 AND id_double = 10030.0 AND id_float = 100030.0" +
            " AND id_binary = 'BINARY测试_30' AND id_boolean = true AND id_date = '2021-09-05'");
    ...
    df = spark.read()
        ...
        .filter("id = 250 AND id_long = 1250 AND id_double = 10250.0 AND id_float = 100250.0" +
            " AND id_binary = 'BINARY测试_250' AND id_boolean = true AND id_date = '2021-09-05'");
