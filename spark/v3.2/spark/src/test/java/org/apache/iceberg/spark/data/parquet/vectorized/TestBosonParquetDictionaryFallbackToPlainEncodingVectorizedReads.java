...
public class TestBosonParquetDictionaryFallbackToPlainEncodingVectorizedReads
    extends TestParquetDictionaryFallbackToPlainEncodingVectorizedReads {
  ...
  @Test
  @Override
  @Ignore // Ignored since Boson doesn't support this yet
