...
public abstract class BaseColumnBatchLoader {
  ...
  protected BaseColumnBatchLoader(DeleteFilter<InternalRow> deletes, long rowStartPosInBatch) {
    this.deletes = deletes;
    this.rowStartPosInBatch = rowStartPosInBatch;
  }

  protected int[] getRowIdMapping() {
    return rowIdMapping;
  }
  ...
  protected ColumnarBatch loadDataToColumnBatch(int numRowsToRead) {
  ...
  protected abstract ColumnVector[] readDataToColumnVectors(int numRowsToRead);
  ...
  protected void initRowIdMapping(int numRowsToRead) {
  ...
  private Pair<int[], Integer> posDelRowIdMapping(int numRowsToRead) {
