    ...
    return (BosonColumnarBatchReader)
        TypeWithSchemaVisitor.visit(expectedSchema.asStruct(), fileSchema,
            new BosonVectorizedReaderBuilder(
                ...
                idToConstant, BosonColumnarBatchReader::new));
  }

  public static BosonColumnarBatchReader buildReader(Schema expectedSchema,
                                                     MessageType fileSchema,
                                                     Map<Integer, ?> idToConstant,
    ...
    return (BosonColumnarBatchReader)
        TypeWithSchemaVisitor.visit(expectedSchema.asStruct(), fileSchema,
            new ReaderBuilder(
                expectedSchema, fileSchema,
                idToConstant, BosonColumnarBatchReader::new, deleteFilter));
  }
