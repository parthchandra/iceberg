...
public class SparkMicroBatchStream implements MicroBatchStream {
  ...
  static SparkMicroBatchStream create(JavaSparkContext sparkContext, Table table, SparkReadConf readConf,
      Schema expectedSchema, String checkpointLocation) {
    ...
    if (conf.getBoolean("iceberg.dropwizard.enable-metrics-collection", false)) {
      ...
      return new MeteredSparkMicroBatchStream(metricRegistry, sparkContext, table, readConf, expectedSchema,
          checkpointLocation);
    } else {
  ...
  private static class MeteredSparkMicroBatchStream extends SparkMicroBatchStream {
    ...
    MeteredSparkMicroBatchStream(MetricRegistry metricRegistry, JavaSparkContext sparkContext, Table table,
        SparkReadConf readConf, Schema expectedSchema, String checkpointLocation) {
