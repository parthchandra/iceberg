...
public class TestClientSideEncryptionProps extends CatalogTestBase {
  ...
  private static Map<String, String> appendCatalogEncryptionConfigProperties(
    ...
    newProps.put(CatalogProperties.ITEV0_ENCRYPTION_IGNORE_TABLE_PROPS, "true");
  ...
  public void testSetTableKeyAPI() {
    ...
    assertThatThrownBy(
        ...
        .hasMessageContaining("wrapping key " + nonExistingKey + " is not found");
