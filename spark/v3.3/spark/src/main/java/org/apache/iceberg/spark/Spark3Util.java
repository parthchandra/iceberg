...
public class Spark3Util {
  ...
  public static Distribution buildRequiredDistribution(
    ...
    return SparkDistributionAndOrderingUtil.buildRequiredDistribution(
        schema, spec, distributionMode, sortOrder);
  }
  ...
  public static SortOrder[] buildRequiredOrdering(
    ...
    return SparkDistributionAndOrderingUtil.buildRequiredOrdering(
        schema, spec, distribution, sortOrder);
  }
  ...
  private static class SpecTransformToSparkTransform implements PartitionSpecVisitor<Transform> {
    ...
    public Transform truncate(String sourceName, int sourceId, int width) {
      ...
      return Expressions.apply("truncate", column, Expressions.literal(width));
    }
