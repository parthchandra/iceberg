...
public class CommitOperations {
  ...
  public static class Overwrite implements CommitOperation<OverwriteFiles> {
    ...
    public static Overwrite files(
      ...
      return new Overwrite(null, false, deletedFiles, readSnapshotId, conflictDetectionFilter, isolationLevel);
    }

    public static Overwrite files(Iterable<DataFile> deletedFiles, IsolationLevel isolationLevel) {
      return new Overwrite(null, false, deletedFiles, null, null, isolationLevel);
    }
    ...
    public OverwriteFiles prepareSnapshotUpdate(Table table, Iterable<DataFile> newFiles) {
      ...
      if (conflictDetectionFilter != null) {
        overwrite.validateNoConflictingAppends(conflictDetectionFilter);
      }
