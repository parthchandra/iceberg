...
import static org.apache.iceberg.spark.SparkWriteOptions.IGNORE_REQUIRED_DISTRIBUTION_AND_ORDERING;
        ...
        () -> {
          try {
            inputDF.writeTo(tableName)
                .option(IGNORE_REQUIRED_DISTRIBUTION_AND_ORDERING, "true")
                .append();
