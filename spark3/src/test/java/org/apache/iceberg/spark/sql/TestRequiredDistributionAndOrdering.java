...
public class TestRequiredDistributionAndOrdering extends SparkCatalogTestBase {
  ...
  @Test
  public void testPartitionColumnsArePrependedForRangeDistributionWithBucketing() throws NoSuchTableException {
    sql("CREATE TABLE %s (c1 INT, c2 STRING, c3 STRING) " +
        "USING iceberg " +
        "PARTITIONED BY (bucket(2, c1))", tableName);
  ...
  @Test
  public void testSortOrderIncludesPartitionColumnsWithBucketing() throws NoSuchTableException {
    sql("CREATE TABLE %s (c1 INT, c2 STRING, c3 STRING) " +
        "USING iceberg " +
        "PARTITIONED BY (bucket(2, c1))", tableName);
  ...
  @Test
  public void testDisabledDistributionAndOrderingWithBucketing() {
    sql("CREATE TABLE %s (c1 INT, c2 STRING, c3 STRING) " +
        "USING iceberg " +
        "PARTITIONED BY (bucket(2, c1))", tableName);
  ...
  @Test
  public void testRangeDistributionWithQuotedColumnNamesAndBucketing() throws NoSuchTableException {
