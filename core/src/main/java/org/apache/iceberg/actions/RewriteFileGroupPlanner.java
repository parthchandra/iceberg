 ...
 * compaction.
 *
 * <p>TODO: Duplicated from RewriteDataFilesSparkAction.planFileGroups/groupByPartition etc, and
...
public class RewriteFileGroupPlanner {
  ...
  public PlanResult plan(Table table, Expression filter, long startingSnapshotId) {
    ...
    return new PlanResult(ctx, groups);
  }
  ...
  public static class PlanResult {
    ...
    private List<RewriteFileGroup> fileGroups;

    public PlanResult(RewriteExecutionContext context, List<RewriteFileGroup> fileGroups) {
    ...
    public List<RewriteFileGroup> fileGroups() {
      return fileGroups;
    }
  }
}
