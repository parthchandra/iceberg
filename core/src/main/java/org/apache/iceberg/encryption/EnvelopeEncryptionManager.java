...
import static org.apache.iceberg.TableProperties.ITEV0_ENCRYPTION_DATA_ALGORITHM;
import static org.apache.iceberg.TableProperties.ITEV0_ENCRYPTION_DATA_ALGORITHM_DEFAULT;
import static org.apache.iceberg.TableProperties.ITEV0_ENCRYPTION_DEK_LENGTH;
import static org.apache.iceberg.TableProperties.ITEV0_ENCRYPTION_PLAINTEXT_ALLOWED;
import static org.apache.iceberg.TableProperties.ITEV0_ENCRYPTION_PLAINTEXT_ALLOWED_DEFAULT;
import static org.apache.iceberg.TableProperties.ITEV0_ENCRYPTION_PUSHDOWN_ENABLED;
import static org.apache.iceberg.TableProperties.ITEV0_ENCRYPTION_PUSHDOWN_ENABLED_DEFAULT;
  ...
  public EnvelopeEncryptionManager(
    ...
    this.nativeFormatEncryption =
        PropertyUtil.propertyAsBoolean(
            tableProperties,
            ITEV0_ENCRYPTION_PUSHDOWN_ENABLED,
            ITEV0_ENCRYPTION_PUSHDOWN_ENABLED_DEFAULT);
    ...
    String dataEncryptionAlgorithm =
        PropertyUtil.propertyAsString(
            tableProperties,
            ITEV0_ENCRYPTION_DATA_ALGORITHM,
            ITEV0_ENCRYPTION_DATA_ALGORITHM_DEFAULT);
    ...
    this.dataKeyLength =
        PropertyUtil.propertyAsInt(
            tableProperties, ITEV0_ENCRYPTION_DEK_LENGTH, ENCRYPTION_DEK_LENGTH_DEFAULT);

    this.allowUnencryptedFiles =
        PropertyUtil.propertyAsBoolean(
            tableProperties,
            ITEV0_ENCRYPTION_PLAINTEXT_ALLOWED,
            ITEV0_ENCRYPTION_PLAINTEXT_ALLOWED_DEFAULT);
