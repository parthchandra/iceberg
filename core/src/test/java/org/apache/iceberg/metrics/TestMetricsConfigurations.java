...
public class TestMetricsConfigurations {
  ...
  public void testNoMetricsEnabledByDefault() {
    ...
    TableOperations meteredTableOps =
        CoreMetricsUtil.wrapWithMeterIfConfigured(
            conf, TableOperationsMetricType.HADOOP, mockTableOps);

    Assert.assertFalse(
        "Metrics not enabled by default. TableOperations should not be an instance of Metered",
  ...
  public void testDisableMetrics() {
    ...
    Assert.assertFalse(
        "Metrics is disabled. TableOperations not should be an instance of Metered",
        meteredTableOps instanceof Metered);
  }
  ...
  public void testEnableMetrics() {
    ...
    Assert.assertTrue(
        "Metrics is enabled. TableOperations should be an instance of Metered",
        meteredTableOps instanceof Metered);
  }
  ...
  public void testEnableMetricsStaticTableOperations() {
    ...
    TableOperations meteredTableOps =
        CoreMetricsUtil.wrapWithMeterIfConfigured(
            conf, TableOperationsMetricType.STATIC, mockTableOps);

    Assert.assertTrue(
        "TableOperations should be an instance of Metered", meteredTableOps instanceof Metered);
  }
}
