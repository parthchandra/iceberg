...
public class TestEnvelopeMetadataParser {
  ...
  public void testParser() {
    ...
    assertThat(parsedMetadata.kekId()).isEqualTo(kekId);
    assertThat(parsedMetadata.wrappedDek()).isEqualTo(wrappedDek);
    assertThat(parsedMetadata.algorithm()).isEqualTo(algo);
