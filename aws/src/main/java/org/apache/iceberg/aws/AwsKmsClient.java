...
public class AwsKmsClient implements KmsClient {
  ...
  public ByteBuffer unwrapKey(String wrappedKey, String wrappingKeyId) {
    ...
    DecryptRequest decryptRequest = DecryptRequest.builder().keyId(wrappingKeyId)
  ...
  public void initialize(Map<String, String> kmsClientTableProperties) {
    ...
    // this will be deleted once we make KMS Client injected with Catalog properties instead of table properties.
    Map<String, String> factoryProperties = Maps.newHashMap();
    factoryProperties.put(AwsProperties.CLIENT_FACTORY, kmsClientTableProperties
            .get(ENCRYPTION_KMS_CLIENT_CUSTOM_PROPERTIES_PREFIX + "." + AwsProperties.CLIENT_FACTORY));
    if (kms == null) {
